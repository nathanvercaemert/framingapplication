...
<script>
    export default {
        ...
        mounted() {
            ...
            document.getElementById("orderType").addEventListener("change", this.editPriceUpdate, false)
            document.getElementById("orderWidth").addEventListener("change", this.editPriceUpdate, false)
            document.getElementById("orderHeight").addEventListener("change", this.editPriceUpdate, false)
            document.getElementById("firstMatNumber").addEventListener("change", this.editPriceUpdate, false)
            document.getElementById("secondMatNumber").addEventListener("change", this.editPriceUpdate, false)
            document.getElementById("thirdMatNumber").addEventListener("change", this.editPriceUpdate, false)
            document.getElementById("orderGlassType").addEventListener("change", this.editPriceUpdate, false)
            document.getElementById("orderFoamcoreType").addEventListener("change", this.editPriceUpdate, false)
            document.getElementById("orderMouldingNumber").addEventListener("change", this.editPriceUpdate, false)

            this.editPriceUpdate();
        },
        methods: {
            editPriceUpdate: function editPriceUpdate() {
            ...
            editPriceUpdateCallback: function editPriceUpdateCallback(response) {
