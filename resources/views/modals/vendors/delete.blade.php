<div class="modal fade" id="deleteVendor" tabindex="-1" role="dialog" aria-labelledby="deleteVendor" aria-hidden="true">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
            ...
            <form method="POST" action="/vendors/delete/{{ $vendor->id }}">
                {{ method_field('DELETE') }}
                {{ csrf_field() }}
