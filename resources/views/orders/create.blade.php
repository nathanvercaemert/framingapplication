                ...
                <div class="card-body">
                    <form class="needs-validation" method="POST" action="/orders" novalidate>
                        ...
                        <div :hidden="isFrame == 0" class="form-row text-right mb-2">
                            ...
                            <div class="col w-50">
                                <input :disabled="isFrame == 0" type="text" class="form-control" name="firstMatNumber" id="firstMatNumber" placeholder="1234" value="{{old('firstMatNumber')}}" style="{{ $errors->has('firstMatNumber') ? 'border-color:red' : '' }}" :required="secondMatNumberIsVisible == 1">
                                <div class="invalid-feedback">
